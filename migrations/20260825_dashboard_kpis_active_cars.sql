-- Dashboard KPI redefinition: Active Cars is Leased-only; Off Rent is Idle∪Abatement∪rent_events;
-- Active OLs count riders with ≥1 active assigned car (not distinct operating rider_external_id).
